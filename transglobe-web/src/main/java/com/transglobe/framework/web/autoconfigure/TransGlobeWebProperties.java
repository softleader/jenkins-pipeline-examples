...
public class TransGlobeWebProperties {
  ...
  WebTraceProperties trace = new WebTraceProperties();

  @Data
  public static class WebTraceProperties {

    ResponseHeaderName responseHeaderName = new ResponseHeaderName();

    @Data
    public static class ResponseHeaderName {

      String traceId = "X-TraceId";
      String spanId = "X-SpanId";
      String parentSpanId = "X-ParentSpanId";
      String sampled = "X-Sampled";
    }
  }
  ...
  @Data
  public static class WebErrorProperties {
